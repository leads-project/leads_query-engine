...
Execute setup_leads:
  cmd.run:
   ...
   - names:
     - cd /root; virtualenv openstack_cli; . openstack_cli/bin/activate; pip install -r /root/requirements.txt
     - cd /root; . openstack_cli/bin/activate; bash /root/setup_leads.sh
