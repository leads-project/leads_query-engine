...
pushd ${BASE_DIR_WITH_MEASUREMENT}
	find * -maxdepth 1 -type f ${MEASUREMENT_MODIFIED_IN_LAST} | xargs -I {} -P 3 swift upload --skip-identical --changed ${MEASUREMENT_CONTAINER} $f --object-name=${MEASUREMENT_PREFIX}{};
